...
test("插件可重复 reload，旧贡献先撤销且新注册不重复", async () => {
  ...
  expect(store.context.tools.entries()).toEqual(["core-tools", "workspace-shell", "subagent", "tool-jobs", "tool-goal", "hyperframes-video", "wechat-article", "workspace-files"]);
